...
NAME=$(mvn help:evaluate -Dexpression=project.name -q -DforceStdout | sed 's/\x1b\[[0-9;]*m//g')
VERSION=$(mvn help:evaluate -Dexpression=project.version -q -DforceStdout | sed 's/\x1b\[[0-9;]*m//g')
